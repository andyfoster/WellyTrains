 ...
 * This means that the Johnsonville-Wellington line is a different train line
 * from
 * the Wellington-Johnsonville line.
 * Although they have the same stations, the stations will be in opposite
 * orders.
 *
 * A TrainLine contains
 * - the name of the TrainLine (originating station - terminal station, eg
 * Wellington-Melling)
 ...
 * (in order of time - services earlier in the list are always earlier times (at
 * any station) than later services )
 */
