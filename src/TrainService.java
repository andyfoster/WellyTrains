 ...
 * - a ID of the train (the name of the line concatenated with the starting time
 * of the train)
 * - a list of times (integers representing 24-hour time, eg 1425 for 2:45pm),
 * one for
 * each station on the train line. A time is -1 if the train does not stop at
 * the station.
